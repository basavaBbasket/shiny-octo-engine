...
public class OrderTest extends BaseTest {
    ...
    public void OrderPlacement() {
        ...
        Response paymentfail = OrderPlacement.placeBBNowOrder("bbnow" , 10 , creds[0], areaName, 1, "ps",searchTerms, "FAILED", false, false, report);
        ...
        Response paymentpending = OrderPlacement.placeBBNowOrder("bbnow" , 10 , creds[0], areaName, 1,"ps", searchTerms, "PENDING", false, false, report);
