...
public class UpdateStoreStatusWithIncompleteField extends BaseTest {
    ...
    @Test(groups = { "bbnow" , "regression", "regression","store_test"}, dataProviderClass = DataProviderClass.class)
