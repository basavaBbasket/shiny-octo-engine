...
public class GetCurrentDeliveryAddress extends BaseTest {
    ...
    @DescriptionProvider(author = "tushar", description = "This TestCase verifies that applicable EC_IDs are part of the respsonse and validates the schema ", slug = "Verify current delivery api response")
