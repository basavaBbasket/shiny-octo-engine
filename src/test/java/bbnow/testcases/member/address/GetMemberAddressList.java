...
public class GetMemberAddressList extends BaseTest {
    ...
    public void getMemberAddressList() {
        ...
        ArrayList<Integer> expectedEcIds = Config.bbnowConfig.get("bbnow_stores[0].sample_address.applicable_ec_ids");
        ...
        Assert.assertEquals(saId, Config.bbnowConfig.getInt("bbnow_stores[0].sa_id"), "SA Id returned from find sas is not equal to expected SA id.");
    }
}
