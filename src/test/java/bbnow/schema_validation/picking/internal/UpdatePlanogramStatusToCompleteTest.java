...
public class UpdatePlanogramStatusToCompleteTest extends BaseTest {
    ...
    @Test(groups = {"bbnow" , "regression","dl2","bbnowvalidation","dl2validation","api-schema-validation","testplan"})
    public void trasnferInApiTest(){
        ...
        String fcid= Config.bbnowConfig.getString("bbnow_stores[1].fc_id");//todo

        String jobid= String.valueOf(DynamicLocationGeneralMethods.getpickingjobid(report));//todo
