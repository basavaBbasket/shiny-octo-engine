...
import msvc.warehouse_inbound_outbound.fcreturn.internal.FcReturnDetails;
...
public class FcReturnDetailsTest extends BaseTest {
    ...
    @Test(groups = {"dl2","bbnow","catalogfc","bbnowvalidation","dl2validation"})
    public void fcReturnApiTest(){
       ...
       FcReturnDetails fcReturnDetails = new FcReturnDetails(xCaller,UserId,fc_id,sku_id,quantity,cp,mrp,Cookie,report);
