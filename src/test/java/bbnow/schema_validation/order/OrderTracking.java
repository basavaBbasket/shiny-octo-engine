...
public class OrderTracking extends BaseTest {
    ...
    public void orderTrackingApiTest(){
        ...
        String orderId = OrderPlacement.placeBBNowOrder(creds[0],"seegehalli",1,new String[]{"biscuit"},true,false,report);
    ...
    @Test(groups = {"bbnow-schema-validation","api-schema-validation","bbnow"})
    ...
    @Test(groups = {"bbnow-schema-validation","api-schema-validation","test1"})
