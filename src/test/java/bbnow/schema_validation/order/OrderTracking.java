...
public class OrderTracking extends BaseTest {
    ...
    @Test(groups = {"bbnow", "regression", "bbnow-schema-validation", "api-schema-validation","revisit"})
    ...
    @Test(groups = {"bbnow-schema-validation", "api-schema-validation", "bbnow", "regression","revisit"})
