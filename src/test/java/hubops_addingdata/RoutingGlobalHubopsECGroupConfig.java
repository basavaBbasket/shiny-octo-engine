...
public class RoutingGlobalHubopsECGroupConfig extends BaseTest {
    WebDriver driver;
    @DataProvider
    public Object[] hubOpsData () throws IOException {
        return ReadExcelData.getTestData("src/main/resources/Croma/Croma.xlsx", "Global Hubops EC Group Config");
    }
    ...
    @DescriptionProvider(slug = "HubOps DataSetup", description = "\"1. Do web login of CromaPage \" +\n" +
            ...
            "            \"            4. Click on Routing module and Global Hubops EC Group Config and add the details\"", author = "Nijaguna")
    @Test(dataProvider = "hubOpsData", groups = {"GlobalHubopsECGroupConfig","Croma","CromaDataSetup"})
    public void test(Map<String,String> testData) throws InterruptedException, IOException {
        String moduleName = "Routing";
        String subModuleName = "Global Hubops EC Group Config";
        ...
        report.log("Navigating to Global Hubops EC Group Config page", true);
        ...
        hubopsPage.globalHubopsECGroupConfig(testData);
        report.log("Global Hubops EC Group Config Data is Added ", true);
