...
public class FieldAssetsShiftType extends BaseTest {
    WebDriver driver;
    @DataProvider
        public Object[] hubOpsData () throws IOException {
            return ReadExcelData.getTestData("src/main/resources/Croma/Croma.xlsx", "Shift Type");
    ...
    @DescriptionProvider(slug = "HubOps DataSetup", description = "\"1. Do web login of CromaPage \" +\n" +
            ...
            "            \"            4. Click on Field Assets and Shift Type and add the details\"", author = "Nijaguna")
    @Test(dataProvider = "hubOpsData", groups = {"ShiftType","Croma","CromaDataSetup"})
    public void test(Map<String,String> testData) throws InterruptedException, IOException {
        String moduleName = "Field Assets ";
        String subModuleName = "Shift Type";
        ...
        report.log("Navigating to Shift Type page", true);
        ...
        hubopsPage.hubopsShiftType(testData);
        report.log("Shift Type Data is Added ", true);
