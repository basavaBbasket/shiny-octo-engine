...
public class RoutingSADMProviderConfig extends BaseTest {
    WebDriver driver;
    @DataProvider
    public Object[] hubOpsData () throws IOException {
        return ReadExcelData.getTestData("src/main/resources/Croma/Croma.xlsx", "SA DM Provider Config");
    }
    ...
    @DescriptionProvider(slug = "HubOps DataSetup", description = "\"1. Do web login of CromaPage \" +\n" +
            ...
            "            \"            4. Click on Routing module and SA DM Provider Config and add the details\"", author = "Nijaguna")
    @Test(dataProvider = "hubOpsData", groups = {"SADMProviderConfig","Croma","CromaDataSetup"})
    public void test(Map<String,String> testData) throws InterruptedException, IOException {
        String moduleName = "Routing";
        String subModuleName = "SA DM Provider Config";
        ...
        report.log("Navigating to SA DM Provider Config", true);
        ...
        hubopsPage.globalSADMProvderConfig(testData);
        report.log("SA DM Provider Config is Added", true);
