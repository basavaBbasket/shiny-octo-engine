...
public class FieldAssetsEarningType extends BaseTest {
    WebDriver driver;
    @DataProvider
    public Object[] hubOpsData() throws IOException {
        return ReadExcelData.getTestData("src/main/resources/Croma/Croma.xlsx", "Earning Type");
    ...
    @DescriptionProvider(slug = "HubOps DataSetup", description = "\"1. Do web login of CromaPage \" +\n" +
            ...
            "            \"            4. Click on Field Assets module and Earning Type and add the details\"", author = "Nijaguna")
    @Test(dataProvider = "hubOpsData", groups = {"EarningType","Croma","CromaDataSetup"})
    public void test(Map<String,String> testData) throws InterruptedException, IOException {
        String moduleName = "Field Assets ";
        String subModuleName = "Earning Type";
        ...
        report.log("Navigating to Earning Type page", true);
        ...
        hubopsPage.hubopsEarningType(testData);
        report.log("Earning Type Data is Added ", true);
