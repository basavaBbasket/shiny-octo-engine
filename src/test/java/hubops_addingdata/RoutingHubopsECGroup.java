...
public class RoutingHubopsECGroup extends BaseTest {
    ...
    public Object[] hubOpsData () throws IOException {
        return ReadExcelData.getTestData("src/main/resources/Croma/Croma.xlsx", "Hubops EC Group");
    }
    ...
    @Test(dataProvider = "hubOpsData", groups = {"HubopsECGroup","Croma","CromaDataSetup"})
    public void test(Map<String,String> testData) throws InterruptedException, IOException {
        ...
        report.log("Navigating to Hubops EC Group", true);
        ...
        hubopsPage.hubopsECGroup(testData);
        report.log("Hubops EC Group is Added", true);
