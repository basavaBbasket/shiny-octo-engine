...
public class RoutingGlobalDMConfig extends BaseTest {
    WebDriver driver;
    @DataProvider
    public Object[] hubOpsData () throws IOException {
        return ReadExcelData.getTestData("src/main/resources/Croma/Croma.xlsx", "Global DM Config");
    }
    ...
    @DescriptionProvider(slug = "HubOps DataSetup", description = "\"1. Do web login of CromaPage \" +\n" +
            ...
            "            \"            4. Click on Routing module and Global DM Config add the details\"", author = "Nijaguna")
    @Test(dataProvider = "hubOpsData", groups = {"GlobalDMConfig","Croma","CromaDataSetup"})
    public void test(Map<String,String> testData) throws InterruptedException, IOException {
        String moduleName = "Routing";
        String subModuleName = "Global DM Config";
        ...
        report.log("Navigating to Global DM Config page", true);
        ...
        hubopsPage.globalDMConfig(testData);
        report.log("Global DM Config Data is Added ", true);
