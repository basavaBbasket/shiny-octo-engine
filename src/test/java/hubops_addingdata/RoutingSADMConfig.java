...
public class RoutingSADMConfig extends BaseTest {
    WebDriver driver;
    @DataProvider
    public Object[] hubOpsData () throws IOException {
        return ReadExcelData.getTestData("src/main/resources/Croma/Croma.xlsx", "SA DM Config");
    }
    @DescriptionProvider(slug = "HubOps DataSetup", description = "\"1. Do web login of CromaPage \" +\n" +
            ...
            "            \"            4. Click on Routing module and SA DM Config and add the details\"", author = "Nijaguna")
    @Test(dataProvider = "hubOpsData", groups = {"SADMConfig","Croma","CromaDataSetup"})
    public void test(Map<String,String> testData) throws InterruptedException, IOException {
        String moduleName = "Routing";
        String subModuleName = "SA DM Config";
        ...
        report.log("Navigating to SA DM Config", true);
        ...
        hubopsPage.globalSADMConfig(testData);
        report.log("SA DM Config is Added", true);
