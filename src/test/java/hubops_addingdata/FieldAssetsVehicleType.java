...
public class FieldAssetsVehicleType extends BaseTest {
    WebDriver driver;
    @DataProvider
    public Object[] hubOpsData () throws IOException {
        return ReadExcelData.getTestData("src/main/resources/Croma/Croma.xlsx", "Vehicle Type");
    ...
    @DescriptionProvider(slug = "HubOps DataSetup", description = "\"1. Do web login of CromaPage \" +\n" +
            ...
            "            \"            4. Click on Field Assets and Vehicle Type and add the details\"", author = "Nijaguna")
    @Test(dataProvider = "hubOpsData", groups = {"VehicleType","Croma","CromaDataSetup"})
    public void test(Map<String,String> testData) throws InterruptedException, IOException, ParseException {
        ...
        String subModuleName = "Vehicle Type";
        ...
        report.log("Navigating to Vehicle Type page", true);
        ...
        hubopsPage.hubopsVehicleType(testData);
        report.log("Vehicle Type Data is Added ", true);
