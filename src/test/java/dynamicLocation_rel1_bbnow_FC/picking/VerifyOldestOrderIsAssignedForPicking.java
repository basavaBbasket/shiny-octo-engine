...
public class VerifyOldestOrderIsAssignedForPicking extends BaseTest {
    ...
    public void verifyOldestOrderIsAssignedForPicking() {
        ...
        int orderId2 = Integer.parseInt(OrderPlacement.placeBBNowOrder(cred[0], areaName, skuMap, true, false, report));

        int orderId = PickingMethods.invokeJobAssignmentApi(fcId, adminUserName, pwd, report);
