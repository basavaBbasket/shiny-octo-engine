package dynamicLocation_rel1_bbnow_FC.stacking;
...
public class StackingFlow extends BaseTest {
    ...
    @Test(groups = {"bbnow", "dlphase2", "stackingFlow","earlyrelease"})
    public void validateStackingFlow() {
        ...
        //TODO make it dynamic post dharmesh fixes data script
        int skuID = 100550;

        StackingMethods.grnStackingFlow(fcId, skuID, adminUserName,pwd, stackingBody,report);
    }
}
