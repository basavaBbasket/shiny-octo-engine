...
public class CustomerOTPRequestTest extends BaseTest {
    ...
    public void validCustomerOTPRequest() throws IOException {
        ...
        CustomerOTPRequest customerOTPRequest = new CustomerOTPRequest(csurftoken,channel,tracker);
        Response response = customerOTPRequest.validateOTPRequestResponse(serverName,"schema//fandv//CustomerOTPRequest-200.json",identifier,report);
