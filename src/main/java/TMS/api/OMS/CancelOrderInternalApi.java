...
public class CancelOrderInternalApi extends WebSettings implements Endpoints {
    ...
    public CancelOrderInternalApi(IReport report, String xCaller, String xEntryContext, String xEntryContextId, String xOriginContext, String xTenantId, String xProject) {
        this.report = report;
    ...
    public Response cancelOrderInternal(Integer orderId, Integer reason_id) {
        String endpoint = String.format(TMS.api.OMS.Endpoints.CANCEL_ORDER_INTERNAL, orderId);
    ...
    public static void doCancellation(IReport report, Map<String,String> headerData, Integer orderId, Integer reason_id) {
        CancelOrderInternalApi cancelOrderInternalApi = new CancelOrderInternalApi(report,headerData.get("xCaller"),headerData.get("entryContext"),headerData.get("entryContextId"),headerData.get("originContext"),headerData.get("tenantId"),headerData.get("projectId"));
