...
import static TMS.configAndUtilities.TmsDBQueries.getUpperBoundForOffset;
...
public class MemberData {
    ...
    public static Map<String, String> getMemberDetailsMap(String env)
    {
        ...
        TMS_UPPERBOUND_FOR_OFFSET = TmsDBQueries.getUpperBoundForOffset(dbName,"select count(*) from member_member");
