...
public class ConfirmOrderApi extends WebSettings implements Endpoints {
    ...
    public Response confirmOrder(Integer reservationId,String orderType) throws IOException {

        String endpoint = String.format(TMS.Endpoints.CONFIRM_ORDER);
       ...
       // requestHeader.put("Host",Host);
        ...
        String requestBody = createConfirmOrderBody(reservationId, orderType);
    ...
    private String createConfirmOrderBody(Integer reservationId , String orderType) {
