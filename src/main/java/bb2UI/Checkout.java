...
public class Checkout extends WebSettings {
    ...
    @FindBy(xpath = "//div[@class='grid grid-flow-col gap-x-2.5']//a//*[name()='svg']//*[name()='g' and contains(@mask,'url(#baske')]//*[name()='path' and contains(@fill,'#fff')]")
    WebElement basket;
    ...
    @FindBy(xpath = "//div[contains(@class,'StyledTabGroupTabHeaderList')]//div[1]//div")
    ...
    @FindBy(xpath = "//div[1]//div[2]//div[1]//ul[1]/li[1]/div[1]/div[3]/div[1]/div[1]/button[1]")
