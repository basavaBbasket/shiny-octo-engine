...
public class IrcdcOrderAction extends WebSettings {
    ...
    public ArrayList<String[]> ircdcUploadData( ArrayList<Integer> sku_id, ArrayList<Integer> quantity){
    ...
    public String ircdcuploadfilepath(ArrayList<Integer>skulist, ArrayList<Integer>quantity) throws IOException {
        ArrayList<String[]> Prepareddata= ircdcUploadData(skulist,quantity);
        UploadFile uploadFile=new UploadFile(report);
       return uploadFile.create_upload_file(Prepareddata,"ircdc/","IRCDC.xlsx");
