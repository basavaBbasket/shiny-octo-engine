...
public class Order extends WebSettings {
    ...
    @FindBy(xpath = "//*[@id='app']/div/div[2]/div[2]/div[22]")
    WebElement entrycontextElement;

    @FindBy(xpath = "//*[@id='app']/div/div[2]/div[2]/div[16]")
    ...
    public ArrayList<Boolean> verifySourceShowsEntryContextAsBB() {
        ...
        checkElementIsPresent.add(entrycontextElement.getText().contains(Config.bbnowConfig.getString("entry_context_id")));
        wait.until(ExpectedConditions.visibilityOf(channelElement));
        report.log("Channel same as source",true);
        checkElementIsPresent.add(channelElement.getText().contains("Bb android app"));
