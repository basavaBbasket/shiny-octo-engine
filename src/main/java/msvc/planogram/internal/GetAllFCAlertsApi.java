...
public class GetAllFCAlertsApi extends WebSettings implements Endpoints {
    ...
    public Response getAllFcAlerts(String expectedResponseSchemaPath ,String fc_id)
    {
        String endpoint = String.format(msvc.planogram.internal.Endpoints.GET_ALL_FC_ALERTS , fc_id);
    ...
    public Response getAllFcAlerts(String fc_id)
    {
        String endpoint = String.format(msvc.planogram.internal.Endpoints.GET_ALL_FC_ALERTS, fc_id);
