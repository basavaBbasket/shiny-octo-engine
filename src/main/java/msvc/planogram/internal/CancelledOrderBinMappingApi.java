...
public class CancelledOrderBinMappingApi extends WebSettings implements Endpoints {
    ...
    public CancelledOrderBinMappingApi(String orderId,IReport report)
    {
        this.report = report;
    ...
    public Response getCancelledOrderBinMappingApi(String expectedResponseSchemaPath , String fc_id)
    {
    ...
    public Response getCancelledOrderBinMappingApi(String fc_id)
    {
        String endpoint = String.format(msvc.planogram.internal.Endpoints.ORDER_BIN_MAPPING , fc_id);
