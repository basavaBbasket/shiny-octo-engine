...
public class GetPickerJobsApi extends WebSettings implements Endpoints {
    ...
    public GetPickerJobsApi(IReport report)
    {
        this.report = report;
    ...
    public Response getPickerJob(String expectedResponseSchemaPath)
    {
        String endpoint = String.format(msvc.planogram.internal.Endpoints.GET_PICKER_JOB);
