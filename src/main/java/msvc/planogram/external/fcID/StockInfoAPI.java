...
public class StockInfoAPI extends WebSettings implements Endpoints {
    IReport report;
    private RequestSpecification requestSpecification;
    private final String xCaller;

    public StockInfoAPI(String xCaller, IReport report){
        this.xCaller = xCaller;
        this.report = report;
        this.requestSpecification = getSimpleRequestSpecification(msvcServerName, this.report);
    }

    public Response GetStockInfoAPI(Map cookie, String expectedResponseSchemaPath) {
        String endpoint = String.format(api.warehousecomposition.planogram_FC.internal.Endpoints.WareHouseCompositionFCPlanogram.STOCK_INFO,1,4002);
