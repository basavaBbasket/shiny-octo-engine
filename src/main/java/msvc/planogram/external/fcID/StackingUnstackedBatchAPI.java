...
public class StackingUnstackedBatchAPI extends WebSettings implements Endpoints {
    IReport report;
    private RequestSpecification requestSpecification;
    private final String xCaller;

    public StackingUnstackedBatchAPI(String xCaller, IReport report){
        this.xCaller = xCaller;
        this.report = report;
        this.requestSpecification = getSimpleRequestSpecification(msvcServerName, this.report);
    }

    public Response GetStackingUnstackedBatchAPI(String sku_id, Map cookie, String expectedResponseSchemaPath) {
        String endpoint = String.format(api.warehousecomposition.planogram_FC.internal.Endpoints.WareHouseCompositionFCPlanogram.GRN_STACKING_UNSTACKED_BATCH,1, sku_id);
