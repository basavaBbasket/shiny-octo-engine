...
public class StackingAlternateBinAPI extends WebSettings implements msvc.order.internal.Endpoints {
    IReport report;
    private RequestSpecification requestSpecification;
    private final String xCaller;

    public StackingAlternateBinAPI(String xCaller, IReport report){
        this.xCaller = xCaller;
        this.report = report;
        this.requestSpecification = getSimpleRequestSpecification(msvcServerName, this.report);
    }

    public Response PostStackingAlternateBinAPI(JsonObject body, Map cookie, String expectedResponseSchemaPath) {
        String endpoint = String.format(Endpoints.WareHouseCompositionFCPlanogram.GRN_STACKING_ALTERNATE_BIN,1);
