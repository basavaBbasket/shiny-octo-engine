...
public class FcReturnDetails extends WebSettings {
     ...
     * @param report
     */
    public FcReturnDetails ( String xCaller, String UserId,String fc_id,int sku_id ,int quantity,double cp, double mrp,int destination_fc_id,String Cookie, IReport report) {
        this.report = report;
