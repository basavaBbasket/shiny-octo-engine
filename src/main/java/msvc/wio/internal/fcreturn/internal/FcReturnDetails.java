...
public class FcReturnDetails extends WebSettings {
     ...
     * @param report
     */
    public FcReturnDetails ( String xEntry_context,String xEntry_context_id ,String xCaller, String UserId,String fc_id,int sku_id ,int quantity,double cp, double mrp,int destination_fc_id,String Cookie, IReport report) {
        this.report = report;
        ...
        this.mrp=mrp;
        this.Cookie=Cookie;
        this.destination_fc_id=destination_fc_id;
    ...
    public Response fcReturn() {
        ...
        skuinfo.put("sku_id",sku_id).put("quantity",quantity).put("cp",cp).put("mrp",mrp).put("destination_fc_id",destination_fc_id);
