...
import msvc.planogram.external.*;
...
public class DynamicLocationGeneralMethods extends WebSettings {
    ...
    public static int getBatchIdForGivenSkuIDPlanogramID(int skuID, int planogramID, IReport report) {
        ...
        report.log("BatchID for the given skuID: " + skuID + " warehouseID : "
                + DynamicLocationGeneralMethods.getWareHouseIDForGivenPlanogramID(planogramID) + " is : " + batchID, true);
        return batchID;
    }
