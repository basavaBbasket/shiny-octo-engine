...
public class ValidatePaymentsApi extends WebSettings implements Endpoints{
    ...
    public ValidatePaymentsApi(  String xEntryContext ,String xEntryContextId, String ContentType ,String Service,String bbDecodedMid, String xCaller, IReport report ){
