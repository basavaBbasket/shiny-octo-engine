...
public class OrderListApi extends WebSettings implements Endpoints {
    ...
    /**
     * This method makes POST request to order list api.
    ...
    public Response getorderList(ArrayList eclist) {
        ...
        report.log("Calling getorderList api. " +
                ...
                "\n Headers: " + requestHeader.toString(), true);
        JSONObject body=new JSONObject();
        body.put("page",1).put("context","active").put("group_by","po").put("modifications",true).put("old_system_orders",false).put("ec_ids",eclist).put("sort_by","creation_date");
