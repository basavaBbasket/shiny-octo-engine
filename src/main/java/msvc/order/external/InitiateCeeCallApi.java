...
public class InitiateCeeCallApi extends WebSettings implements Endpoints {
    IReport report;
    ...
    public InitiateCeeCallApi(String xservice, String xCaller, String xEntryContextId, String xEntryContext, String orderId, IReport report) {
        this.report = report;
     ...
     * @return response
     */
    public Response initiateCeeCallApi(String expectedResponseSchemaPath) {
        String endpoint = String.format(Endpoints.INITIATE_CEE_CALL, orderId);
        ...
        report.log("Calling initiateCeeCallApi api. " +
                "\n Endpoint:" + endpoint +
        ...
        report.log("Status code: " + response.getStatusCode() +"\n Live initiateCeeCallApi response: \n" + response.prettyPrint(),true);
    ...
    /**
     * This method makes GET request to initiateCeeCallApi api.
     * Order ID is set during object creation.
     *
     * @return response
     */
    public Response initiateCeeCallApi() {
        String endpoint = String.format(Endpoints.INITIATE_CEE_CALL, orderId);
        Map<String, String> requestHeader = new HashMap<>();
        requestHeader.put("X-Service", xService);
        requestHeader.put("X-Tracker", UUID.randomUUID().toString());
        ...
        Response response = RestAssured.given().spec(requestSpecification)
                ...
                .then().log().all()
                .extract().response();
        report.log("initiateCeeCallApi response: " + response.prettyPrint(),true);
        return response;
    }
}
