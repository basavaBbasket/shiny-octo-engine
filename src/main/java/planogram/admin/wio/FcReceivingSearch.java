...
public class FcReceivingSearch extends WebSettings {
    ...
    public FcReceivingSearch(WebDriver driver,AutomationReport report) {
        this.driver = driver;
        this.report = report;
...
//        Thread.sleep(5000);
//        driver.get(trimmedServerName+"/admin/microservices/list-all/");
//        Thread.sleep(3000);
//        microserviceplanogram.click();
//        Thread.sleep(3000);
//        fcreceivingplanogram.click();
//        Thread.sleep(4000);
