...
public class OrderDetailsInternalApi extends WebSettings implements Endpoints {
    ...
    public OrderDetailsInternalApi(IReport report, String xCaller, String xEntryContext, String xEntryContextId, String xOriginContext, String xTenantId, String xProject) {
        this.report = report;
    ...
    {
        String endpoint = String.format(tms.api.OMS.Endpoints.ORDER_DETAILS_INTERNAL,orderId);
